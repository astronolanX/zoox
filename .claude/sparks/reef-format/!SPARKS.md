...
Thread exploring: Alternative file formats for AI-native memory — moving beyond XML ceremony toward token-efficient structures.

## Timeline

| Date | Topic | Key Emergent Insight | Score |
|------|-------|---------------------|-------|
| 2026-01-15 | reef-format-problem | (initial exploration) | - |
...
The thread is converging on a counterintuitive insight: optimizing the *syntax* (sigils, tags, delimiters) may be solving the wrong problem. The real question is whether explicit metadata is necessary at all, or whether AI can infer type, scope, and lifecycle from content and structure.

Open tensions:
- Explicit vs implicit metadata
- Human-readable vs AI-optimal
- Structure vs prose

## Sparks

- [[2026-01-15-1800-reef-format-problem]] — Initial exploration of XML alternatives
...
- **2026-01-15** Initial spark on reef format problem. Established the 60% token waste baseline with XML.
